...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>({TResult Function( _CheckRequested value)?  checkRequested,TResult Function( _LoginRequested value)?  loginRequested,TResult Function( _LogoutRequested value)?  logoutRequested,required TResult orElse(),}){
final _that = this;
switch (_that) {
case _CheckRequested() when checkRequested != null:
return checkRequested(_that);case _LoginRequested() when loginRequested != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>({required TResult Function( _CheckRequested value)  checkRequested,required TResult Function( _LoginRequested value)  loginRequested,required TResult Function( _LogoutRequested value)  logoutRequested,}){
final _that = this;
switch (_that) {
case _CheckRequested():
return checkRequested(_that);case _LoginRequested():
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>({TResult? Function( _CheckRequested value)?  checkRequested,TResult? Function( _LoginRequested value)?  loginRequested,TResult? Function( _LogoutRequested value)?  logoutRequested,}){
final _that = this;
switch (_that) {
case _CheckRequested() when checkRequested != null:
return checkRequested(_that);case _LoginRequested() when loginRequested != null:
...
switch (_that) {
case _CheckRequested() when checkRequested != null:
return checkRequested();case _LoginRequested() when loginRequested != null:
...
switch (_that) {
case _CheckRequested():
return checkRequested();case _LoginRequested():
